...
public class JuegoAccionController implements Initializable{
    ...
    String preguntas[] = { "Accion1","Accion2","Accion3","Accion4","Accion5" };
    ...
    private void pintar() {
    	graficos.drawImage(new Image("/fes/aragon/recursosAccion/"+pregunta+".png"), 0, 0);
    }
}
