...
public class JuegoEstrategiaController implements Initializable{
    ...
    String preguntas[] = { "Estrategia1","Estrategia2","Estrategia3" };
    ...
    private void pintar() {
    	graficos.drawImage(new Image("/fes/aragon/recursosEstrategia/"+pregunta+".png"), 0, 0);
    }
}