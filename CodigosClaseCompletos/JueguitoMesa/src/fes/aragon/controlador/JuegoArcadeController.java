...
public class JuegoArcadeController implements Initializable{
    ...
    String preguntas[] = { "Arcade1","Arcade2","Arcade3","Arcade4" };
    ...
    private void pintar() {
    	graficos.drawImage(new Image("/fes/aragon/recursosArcade/"+pregunta+".png"), 0, 0);
    }
}
