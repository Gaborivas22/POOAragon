...
public class BaseDeDatos {
	...
	static {
		...
		est.setMaterias(new Materia("Cálculo", 9), new Materia("Programación", 10), new Materia("Lógica", 10));
		estudiantes.add(est);
...
//////////////////////////////////
		...
		est.setMaterias(new Materia("Circuitos Lógicos", 10), new Materia("Lógica de Autómatas", 10));
		estudiantes.add(est);
